...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		var editorId = this.htPopupOption.oApp.elPlaceHolder.id;
		this.htPopupOption.sUrl = this.makePopupURL(editorId);
		this.htPopupOption.sProperties = "left=0,top=0,width=388,height=359,scrollbars=no,location=no,status=0,resizable=no";
	 ...
	 */
	makePopupURL : function(editorId){
		//var sPopupUrl = "./photo_uploader/popup/photo_uploader.html";
		var sPopupUrl = "../../../common/editorUploadForm?editorId="+editorId;
		return sPopupUrl;
	},
